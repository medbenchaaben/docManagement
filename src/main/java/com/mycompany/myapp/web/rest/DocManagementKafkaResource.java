...
@RestController
@RequestMapping("/api/doc-management-kafka")
public class DocManagementKafkaResource {
    private final Logger log = LoggerFactory.getLogger(DocManagementKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DocManagementKafkaResource(KafkaProperties kafkaProperties) {
